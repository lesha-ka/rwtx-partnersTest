...
// Mobile menu
var burger = document.querySelector('.js-burgerBtn');
var menu = document.querySelector('.js-mobileMenu');
burger.addEventListener('click', function () {
  menu.classList.toggle('active');
  var bodyOverflow = window.getComputedStyle(document.body).overflowY;
  document.body.style.overflowY = bodyOverflow === 'hidden' ? 'auto' : 'hidden';
});
// Menu dropdowns
var menuMobileDropdowns = document.querySelectorAll('.js-dropdownMenu');
menuMobileDropdowns.forEach(function (arrow) {
...
// Lang block
var openLang = document.querySelector('.js-openLang');
var closeLang = document.querySelector('.js-closeLang');
var mobileLang = document.querySelector('.js-mobileLang');
openLang.addEventListener('click', function () {
  // mobile
...
// desktop
if (window.matchMedia('(hover: hover) and (pointer: fine)').matches) {
  var isMouseOverMobileLang = false;
  openLang.addEventListener('mouseenter', function () {
    if (profileBlock.classList.contains('active')) {
      profileBlock.classList.remove('active');
    }
    mobileLang.classList.add('active');
  });
  openLang.addEventListener('mouseleave', function () {
    setTimeout(function () {
      if (!isMouseOverMobileLang) {
        mobileLang.classList.remove('active');
      }
    }, 100);
  });
  mobileLang.addEventListener('mouseenter', function () {
    isMouseOverMobileLang = true;
    mobileLang.classList.add('active');
  });
  mobileLang.addEventListener('mouseleave', function () {
    isMouseOverMobileLang = false;
    mobileLang.classList.remove('active');
  });
}

// Select lang items
var mobileLangItems = document.querySelectorAll('.js-mobileLangItem');
mobileLangItems.forEach(function (lang) {
...
// Profile block
var openProfile = document.querySelector('.js-openProfile');
var profileBlock = document.querySelector('.js-header-profile');
...
// desktop
if (window.matchMedia('(hover: hover) and (pointer: fine)').matches) {
  var isMouseOverProfileBlock = false;
  openProfile.addEventListener('mouseenter', function () {
    if (mobileLang.classList.contains('active')) {
      mobileLang.classList.remove('active');
    }
    profileBlock.classList.add('active');
  });
  openProfile.addEventListener('mouseleave', function () {
    setTimeout(function () {
      if (!isMouseOverProfileBlock) {
        profileBlock.classList.remove('active');
      }
    }, 100);
  });
  profileBlock.addEventListener('mouseenter', function () {
    isMouseOverProfileBlock = true;
    profileBlock.classList.add('active');
  });
  profileBlock.addEventListener('mouseleave', function () {
    isMouseOverProfileBlock = false;
    profileBlock.classList.remove('active');
  });
}
...
/* harmony import */ var _modules_application_application__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/application/application */ "./src/blocks/modules/application/application.js");
/* harmony import */ var _modules_application_application__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_application_application__WEBPACK_IMPORTED_MODULE_2__);
